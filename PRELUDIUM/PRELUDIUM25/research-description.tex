...
% Core references that define isotope behaviour in the hydrological cycle.
...
% Fundamental parameterizations used in isotope models.
...
% Required for any discussion of non-equilibrium evaporation.
...
% Most important section for studies of precipitation isotope modification.
...
% Physical basis of cloud formation and hydrometeor evolution.
...
% Physical parameterizations often used in isotope evaporation models.
...
% Isotope effects during condensation, freezing, and ice growth.
...
% Observational constraints and process studies.
...
% References typically cited in the methods section.
...
\begin{itemize}
    ...
    \item \textbf{Maruyama \& Tada (2014)} -- CRDS versus IRMS comparison.
    \item \textbf{De Graaf et al. (2020)} -- CRDS versus IRMS evaluation.
...
% General atmospheric and aerosol physics references.

\begin{itemize}
    \item \textbf{Seinfeld \& Pandis (2016)} -- Atmospheric chemistry and physics reference.
    \item \textbf{Hänel (1976)} -- Hygroscopic aerosol growth.
...
\section{Peripheral or Unrelated References}

\begin{itemize}
    \item Craig GA (1999) -- Germany 1866--1945.
    \item Harrison (1970) -- Big Bang cosmology.
    \item Jasek et al. (2014) -- Soil CO$_2$ isotopes.
    \item Röckmann et al. (2016) -- Clumped isotopes.
    \item Whitman \& Lehmann (2015) -- Source partitioning methodology.
    \item Yamborko et al. (2026) -- Cellular metabolic activity.
\end{itemize}
%----------------------------------------------------%
...
Water stable isotopologues serve as the natural tracers in the global hydrological cycles of the Earth.

% From chat - introduction:
The isotopic composition of atmospheric water constitutes one of the most informative tracers of processes occurring
within the Earth system.
Stable water isotopes are widely used in atmospheric sciences, climatology, hydrology, and geochemistry
...
The interpretation of isotopic observations relies on an accurate understanding of isotopic fractionation
processes governing the evolution of water vapor and liquid water in natural environments.

The primary objective of the proposed project is to develop a mathematically rigorous and physically consistent
framework describing isotopic fractionation during diffusional processes involving stable water isotopes.
The project aims to formulate, analyze, and implement a process-based model capable of reproducing
...
A further objective is to evaluate the predictive capability of the developed framework through systematic
...
Stable isotopes of water (^1H^2H^16O, ^1H^1H^18O, ^1H^1H^17O and related isotopologues)
...
Ad.~\ref{itm-maths}: Mathematical description of the assumptions of the models with approximation analysis
...
Ad.~\ref{itm-code}:
Preliminary: Implementations in PySDM (as stated in the previous NCN grant) {\color{blue}Q: should I mention it here?} 
In PySDM - extending code with water-ice interactions.
...
\bottomrule
\end{tabular}
\caption{Risk analysis and mitigation measures.}
\end{table}
...
Describe data sources and acquisition procedures.

\subsection{Data Analysis}

Describe analysis procedures and validation methods.

\subsection{Research Infrastructure}

Describe equipment, laboratory facilities, software, databases,
...
\section{Research Team and Qualifications}
...
Describe the competencies relevant to the project.
...
\begin{itemize}
    ...
    \item Patents
    \item Awards
    \item Previous grants
    \item Other relevant achievements
\end{itemize}
...
\begin{center}
\textbf{End of the 15-page project description section}
\end{center}
